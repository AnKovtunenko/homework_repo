...
//min1 
var year = prompt("Введіть свій вік");
...
var rangeStart = +prompt("Введіть початок діапазону");
var rangeEnd = +prompt("Введіть кінець діапазону");
var sum = 0;
...
console.log("Sum: ", sum); // Запитай у користувача 2 числа і знайди найбільший спільний дільник.

var firstNum = prompt('Input first number');
var secondNum = prompt('Input second number');
var maxNum = Math.max(firstNum, secondNum);

for (var _i = maxNum; _i > 0; _i--) {
  if (firstNum % _i === 0 && secondNum % _i === 0) {
    console.log('Найбільший спільний дільник: ', _i);
    break;
  }
...
var amount = prompt('Введіть суму покупки плес');
...
for (var _i3 = 0; _i3 < totalNumbers; _i3++) {
  var userInput = prompt('Введіть число');
...
console.log('Кількість непарних чисел: ', oddCount); // Зацикли відображення днів тижня таким чином: «День тижня. Хочеш побачити наступний день? » і так до тих пір, поки користувач натискає OK.
...
do {
  userResponse = confirm("".concat(daysOfWeek[currentDayIndex], ". \u0425\u043E\u0447\u0435\u0448 \u043F\u043E\u0431\u0430\u0447\u0438\u0442\u0438 \u043D\u0430\u0441\u0442\u0443\u043F\u043D\u0438\u0439 \u0434\u0435\u043D\u044C?"));
  if (currentDayIndex === 6) currentDayIndex = 0;else {
    currentDayIndex++;
  }
} while (userResponse === true); // Максимум
...
var from = 0;
var to = 100;
var middle = Math.floor(to - from) / 2;

while (!guess) {
  var answer = prompt("\u0412\u0430\u0448\u0435 \u0447\u0438\u0441\u043B\u043E > ".concat(middle, ", < ").concat(middle, " \u0430\u0431\u043E == ").concat(middle, "?")); // if (answer === '>' || answer === '<' || answer === '=') {
...
for (var _i4 = 2; _i4 <= 9; _i4++) {
  for (var j = 1; j <= 10; j++) {
    multiplicationTable.push("".concat(_i4, " x ").concat(j, " = ").concat(_i4 * j));
  }
}

console.log(multiplicationTable); // Запитай дату (день, місяць, рік) і виведи наступну за нею дату. Враховуй можливість переходу на наступний місяць, рік, а також високосний рік.

var day = prompt('Введіть день');
var month = prompt('Введіть місяць');
year = (_readOnlyError("year"), prompt('Введіть рік'));
var isLeapYear = year % 4 === 0 && year % 100 !== 0 || year % 400 === 0;
var daysInMonth = [31, isLeapYear ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
var curDay = prompt('Введіть день');
var curMonth = prompt('Введіть місяць');
var curYear = prompt('Введіть рік');
...
function calcNextDay(day, month, year) {
  ...
  if (month === '2') {
    var _isLeapYear = year % 4 === 0 && year % 100 !== 0 || year % 400 === 0;

    var daysInFebruary = _isLeapYear ? 29 : 28;
  ...
  console.log("\u041D\u0430\u0441\u0442\u0443\u043F\u043D\u0430 \u0434\u0430\u0442\u0430: ".concat(nextDay, "/").concat(nextMonth, "/").concat(nextYear));
}
